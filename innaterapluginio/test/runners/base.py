...
from innaterapluginio.test.exception import UnitTestSuiteError
from innaterapluginio.test.result import TestCase, TestStatus
from innaterapluginio.test.runners.readers.native import NativeTestOutputReader
from innaterapluginio.test.runners.readers.serial import SerialTestOutputReader
...
class TestRunnerBase:
    ...
    def run_project_targets(self, targets):
        ...
        from innaterapluginio.run.cli import cli as run_cmd
