...
from innaterapluginio import __version__, app, fs, util
from innaterapluginio.custom.rpc.handlers.base import BaseRPCHandler
...
class AppRPC(BaseRPCHandler):
    ...
    def load_state():
        with app.State(
            app.resolve_state_path("core_dir", "customstate.json"), lock=True
        ) as state:
            ...
            storage["customDir"] = fs.expanduser("~")
