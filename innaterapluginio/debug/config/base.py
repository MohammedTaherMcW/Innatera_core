...
from innaterapluginio import fs, proc, util
from innaterapluginio.compat import string_types
...
from innaterapluginio.project.helpers import load_build_metadata
...
class DebugConfigBase:  # pylint: disable=too-many-instance-attributes
    ...
    def _configure_server(self):
        # user disabled server in conf.ini
