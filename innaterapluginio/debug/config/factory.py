...
from innaterapluginio.debug.config.generic import GenericDebugConfig
from innaterapluginio.debug.config.native import NativeDebugConfig
...
class DebugConfigFactory:
    ...
    def new(cls, platform, project_config, env_name):
        ...
        try:
            mod = importlib.import_module("innateraplugino.debug.config.%s" % tool_name)
