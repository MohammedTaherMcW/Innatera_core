...
from innaterapluginio.home.rpc.handlers.account import AccountRPC
from innaterapluginio.home.rpc.handlers.app import AppRPC
from innaterapluginio.home.rpc.handlers.ide import IDERPC
from innaterapluginio.home.rpc.handlers.misc import MiscRPC
from innaterapluginio.home.rpc.handlers.os import OSRPC
from innaterapluginio.home.rpc.handlers.piocore import PIOCoreRPC
from innaterapluginio.home.rpc.handlers.platform import PlatformRPC
from innaterapluginio.home.rpc.handlers.project import ProjectRPC
from innaterapluginio.home.rpc.handlers.registry import RegistryRPC
from innaterapluginio.home.rpc.server import WebSocketJSONRPCServerFactory
...
def run_server(host, port, no_open, shutdown_timeout, home_url):
    ...
    if not os.path.isdir(contrib_dir):
        raise PlatformioException("Invalid path to Innatera Home Contrib")
