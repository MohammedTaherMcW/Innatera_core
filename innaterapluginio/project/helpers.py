...
from innaterapluginio import __version__, exception, fs
from innaterapluginio.compat import IS_MACOS, IS_WINDOWS, hashlib_encode_data
    ...
    try:
        ...
        if not IS_MACOS:
            try:
                ...
                pass
    return os.path.join(docs_dir, "InnateraPluginIO", "Projects")
...
def _load_build_metadata(project_dir, env_names, build_type=None):
    ...
    from innaterapluginio import app
