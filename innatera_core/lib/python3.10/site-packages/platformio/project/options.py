    ...
    [
        ...
        for option in [
            ...
            ConfigPlatformioOption(
                ...
                name="default_envs",
                description=(
                    "Configure a list with environments which Innatera should "
                    "process by default"
                ),
            ...
            ConfigPlatformioOption(
                ...
                name="core_dir",
                description=(
                    "Innatera Core location where it keeps installed development "
            ...
            ConfigPlatformioOption(
                ...
                name="globallib_dir",
                description=(
                    "A library folder/storage where Innatera Library Dependency "
            ...
            ConfigPlatformioOption(
                ...
                name="platforms_dir",
                description=(
                    "A location where Innatera Core keeps installed development "
                    "platforms"
                ),
            ...
            ConfigPlatformioOption(
                ...
                name="packages_dir",
                description=(
                    "A location where Innatera Core keeps installed packages"
                ),
            ...
            ConfigPlatformioOption(
                ...
                name="cache_dir",
                description=(
                    "A location where Innatera Core stores caching information "
                    "(requests to Innatera Registry, downloaded packages and "
            ...
            ConfigPlatformioOption(
                ...
                description=(
                    "A location where Innatera Core keeps derived files from a "
            ...
            ConfigPlatformioOption(
                ...
                name="workspace_dir",
                description=(
                    "A path to a project workspace directory where Innatera keeps "
            ...
            ConfigPlatformioOption(
                ...
                name="src_dir",
                description=(
                    "A default location where Innatera Build System looks for the "
            ...
            ConfigPlatformioOption(
                ...
                name="test_dir",
                description=(
                    "A location where Innatera Unit Testing engine looks for "
                    "test source files"
                ),
            ...
            ConfigPlatformioOption(
                ...
                name="shared_dir",
                description=(
                    "A location which Innatera Remote Development service uses to "
            ...
            ConfigEnvOption(
                group="build",
                name="targets",
                description="A custom list of targets for Innatera Build System",
                multiple=True,
            ),
            # Upload
            ConfigEnvOption(
            ...
            ConfigEnvOption(
                ...
                description=(
                    "Allows one to control when Innatera should load debugging "
