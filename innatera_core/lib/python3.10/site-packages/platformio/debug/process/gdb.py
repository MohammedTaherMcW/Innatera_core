...
class GDBClientProcess(DebugClientProcess):
    ...
    INIT_COMPLETED_BANNER = "Innatera: Initialization completed"
    ...
    def _auto_exec_continue(self):
        ...
        self.console_log(
            "Innatera: Resume the execution to `debug_init_break = %s`\n"
            % self.debug_config.init_break
        )
        self.console_log(
            "Innatera: More configuration options -> https://bit.ly/pio-debug\n"
        )
        if self.debug_config.platform.is_embedded():
